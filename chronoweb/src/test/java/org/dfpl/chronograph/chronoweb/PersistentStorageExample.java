...
public class PersistentStorageExample {
	...
	public void testMemoryStorage() {
		PChronoGraph g = new PChronoGraph("mongodb://localhost:27017", "test");
		...
		HashMap<String, Long> gamma = new HashMap<String, Long>();
		gamma.put(jack.getId(), 0l);
